...
public class RestClientTest {
    ...
    public void put() throws Exception {
        ...
        list.add(new User(1l, "赵敏", "女", 25, "排球，足球，游泳", "江苏省", "淮安市", sdf.parse("2017-01-01"), "海纳百川，有容乃大"));
        list.add(new User(2l, "赵忠祥", "男", 58, "足球，书法", "江苏省", "淮安市", sdf.parse("2018-02-31"), "春江潮水连海平，海上明月共潮生"));
        list.add(new User(3l, "孙满堂", "男", 78, "跑步，篮球，羽毛球", "江苏省", "南京市", sdf.parse("2019-01-01"), "白日依山尽，黄河入海流"));
        list.add(new User(4l, "孙膑", "男", 34, "书法，篮球", "江苏省", "南京市", sdf.parse("2019-01-01"), "曾经沧海难为水，除却巫山不是云"));
        list.add(new User(5l, "周武王", "男", 58, "跑步", "山东省", "济南市", sdf.parse("2019-02-01"), "北风卷地白草折，胡天八月即飞雪"));
        list.add(new User(6l, "吴文周", "男", 50, "排球，游泳，足球", "山东省", "济南市", sdf.parse("2019-02-01"), "千山鸟飞绝，万径人踪灭。孤舟蓑笠翁，独钓寒江雪"));
        list.add(new User(7l, "郑爽", "女", 28, "乒乓球，高尔夫，台球", "山东省", "青岛市", sdf.parse("2019-11-21"), "孤舟蓑笠翁，独钓寒江雪"));
        list.add(new User(8l, "郑成功", "男", 28, "台球，足球", "山东省", "青岛市", sdf.parse("2019-11-25"), "柴门闻犬吠，风雪夜归人"));
